...
fn lut_defs() -> [LutDef; LUTS_REGISTRY_SIZE] {
    use Lut1Def::*;
    use Lut2Def::*;
    [
        LutDef::One(None),
...
pub fn build_registry(params: &VmConfig, registry: &mut [u64]) {
...
fn build_accumulator(params: &VmConfig, def: &LutDef, out: &mut [u64]) {
    out.fill(0);
