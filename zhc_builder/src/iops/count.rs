    ...
    fn test_count0() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                // last Column 0 / zero and first reduction    | %34, %35 = pbs2<Protect, Lut2("ManyInv7CarryMsg")>(%33);
                ...
                // last Column 0 / zero and first reduction    | %42, %43 = pbs2<Protect, Lut2("ManyInv7CarryMsg")>(%41);
                ...
                // last Column 0 / zero and first reduction    | %47, %48 = pbs2<Protect, Lut2("ManyInv4CarryMsg")>(%46);
                // count_reduce_recursive / regular Column 0   | %49 = add_ct(%34, %42);
                // count_reduce_recursive / regular Column 0   | %50 = add_ct(%49, %47);
                // count_reduce_recursive / regular Column 0   | %51 = pbs<Protect, Lut1("MsgOnly")>(%50);
                // count_reduce_recursive / regular Column 0   | %52 = pbs<Protect, Lut1("CarryInMsg")>(%50);
                // count_reduce_recursive / last Column 1      | %53 = add_ct(%35, %43);
                // count_reduce_recursive / last Column 1      | %54 = add_ct(%53, %48);
                // last Column 1 / common branch               | %55, %56 = pbs2<Protect, Lut2("ManyCarryMsg")>(%54);
