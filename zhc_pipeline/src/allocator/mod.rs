...
mod test {
    ...
    use crate::{scheduler, test::check_iop_dop_equivalence, translation::lower_iop_to_hpu};
    ...
    fn test_allocate_add_ir() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %8 = LD<R(5), TC(1, 3)>(%7);
                %9 = LD<R(6), TC(1, 4)>(%8);
                %10 = ADD<R(3), R(3), R(4)>(%9);
                %11 = LD<R(4), TC(1, 2)>(%10);
                %12 = LD<R(7), TC(1, 1)>(%11);
                %13 = LD<R(8), TC(1, 0)>(%12);
                %14 = LD<R(9), TC(0, 1)>(%13);
                %15 = ADD<R(1), R(1), R(4)>(%14);
                %16 = LD<R(4), TC(0, 4)>(%15);
                %17 = LD<R(10), TC(0, 3)>(%16);
                %18 = LD<R(11), TC(1, 7)>(%17);
                %19 = LD<R(12), TC(0, 7)>(%18);
                %20 = ADD<R(0), R(0), R(8)>(%19);
                %21 = ADD<R(4), R(4), R(6)>(%20);
                %22 = ADD<R(5), R(10), R(5)>(%21);
                %23 = ADD<R(6), R(9), R(7)>(%22);
                %24 = PBS<R(7), R(6), LUT(47)>(%23);
                %25 = PBS2<R(8, 2), R(0), LUT(26)>(%24);
                %26 = PBS<R(10), R(1), LUT(48)>(%25);
                %27 = PBS<R(13), R(5), LUT(49)>(%26);
                %28 = PBS<R(14), R(3), LUT(48)>(%27);
                %29 = PBS<R(15), R(4), LUT(47)>(%28);
                %30 = PBSF<R(16), R(2), LUT(49)>(%29);
                %31 = ADD<R(0), R(12), R(11)>(%30);
                %32 = ADD<R(7), R(9), R(7)>(%31);
                %33 = ADD<R(6), R(6), R(9)>(%32);
                %34 = ADD<R(9), R(7), R(10)>(%33);
                %35 = ADD<R(10), R(9), R(13)>(%34);
                %36 = PBS<R(11), R(10), LUT(46)>(%35);
                %37 = PBS<R(12), R(9), LUT(45)>(%36);
                %38 = PBS<R(13), R(7), LUT(44)>(%37);
                %39 = PBS<R(17), R(6), LUT(1)>(%38);
                %40 = PBSF<R(18), R(8), LUT(1)>(%39);
                %41 = ADD<R(6), R(15), R(14)>(%40);
                %42 = ADD<R(7), R(6), R(16)>(%41);
                %43 = ST<TC(0, 1), R(17)>(%42);
                %44 = ADD<R(8), R(15), R(11)>(%43);
                %45 = ST<TC(0, 0), R(18)>(%44);
                %46 = ADD<R(7), R(7), R(11)>(%45);
                %47 = ADD<R(1), R(1), R(13)>(%46);
                %48 = ADD<R(5), R(5), R(12)>(%47);
                %49 = ADD<R(6), R(6), R(11)>(%48);
                %50 = ADD<R(4), R(4), R(11)>(%49);
                %51 = PBS<R(9), R(7), LUT(46)>(%50);
                %52 = PBS<R(10), R(6), LUT(45)>(%51);
                %53 = PBS<R(11), R(8), LUT(44)>(%52);
                %54 = PBS<R(12), R(1), LUT(1)>(%53);
                %55 = PBS<R(13), R(5), LUT(1)>(%54);
                %56 = PBSF<R(14), R(4), LUT(1)>(%55);
                %57 = ST<TC(0, 2), R(12)>(%56);
                %58 = ADD<R(0), R(0), R(9)>(%57);
                %59 = ST<TC(0, 3), R(13)>(%58);
                %60 = ST<TC(0, 4), R(14)>(%59);
                %61 = ADD<R(1), R(2), R(10)>(%60);
                %62 = ADD<R(2), R(3), R(11)>(%61);
    ...
    fn test_allocate_cmp_ir() {
        ...
        assert_display_is!(
            ...
            r#"
                ...
                %6 = LD<R(5), TC(1, 7)>(%5);
                %7 = LD<R(6), TC(1, 4)>(%6);
                %8 = MAC<R(3), R(5), R(3), PT_I(4)>(%7);
                %9 = LD<R(5), TC(1, 3)>(%8);
                %10 = LD<R(7), TC(1, 2)>(%9);
                %11 = LD<R(8), TC(1, 1)>(%10);
                %12 = MAC<R(4), R(4), R(6), PT_I(4)>(%11);
                %13 = LD<R(6), TC(1, 0)>(%12);
                %14 = LD<R(9), TC(0, 5)>(%13);
                %15 = LD<R(10), TC(0, 7)>(%14);
                %16 = LD<R(11), TC(0, 4)>(%15);
                %17 = MAC<R(5), R(5), R(7), PT_I(4)>(%16);
                %18 = LD<R(7), TC(0, 1)>(%17);
                %19 = LD<R(12), TC(0, 3)>(%18);
                %20 = MAC<R(6), R(8), R(6), PT_I(4)>(%19);
                %21 = MAC<R(8), R(9), R(11), PT_I(4)>(%20);
                %22 = MAC<R(1), R(12), R(1), PT_I(4)>(%21);
                %23 = MAC<R(2), R(10), R(2), PT_I(4)>(%22);
                %24 = MAC<R(0), R(7), R(0), PT_I(4)>(%23);
                %25 = PBS<R(7), R(3), LUT(0)>(%24);
                %26 = PBS<R(9), R(4), LUT(0)>(%25);
                %27 = PBS<R(10), R(5), LUT(0)>(%26);
                %28 = PBS<R(11), R(6), LUT(0)>(%27);
                %29 = PBS<R(12), R(2), LUT(0)>(%28);
                %30 = PBS<R(13), R(8), LUT(0)>(%29);
                %31 = PBS<R(14), R(1), LUT(0)>(%30);
                %32 = PBSF<R(15), R(0), LUT(0)>(%31);
                %33 = SUB<R(0), R(12), R(7)>(%32);
                %34 = SUB<R(1), R(14), R(10)>(%33);
                %35 = SUB<R(2), R(13), R(9)>(%34);
                %36 = SUB<R(3), R(15), R(11)>(%35);
                %37 = PBS<R(4), R(3), LUT(40)>(%36);
                %38 = PBS<R(5), R(1), LUT(40)>(%37);
                %39 = PBS<R(6), R(2), LUT(40)>(%38);
                %40 = PBSF<R(7), R(0), LUT(40)>(%39);
                %41 = ADDS<R(0), R(4), PT_I(1)>(%40);
                %42 = ADDS<R(1), R(6), PT_I(1)>(%41);
                %43 = ADDS<R(2), R(5), PT_I(1)>(%42);
                %44 = ADDS<R(3), R(7), PT_I(1)>(%43);
                %45 = MAC<R(0), R(2), R(0), PT_I(4)>(%44);
                %46 = MAC<R(1), R(3), R(1), PT_I(4)>(%45);
